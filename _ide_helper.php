...
namespace Scalar\Facades {
    ...
    class Scalar {
        ...
        {
            return \Scalar\Scalar::pageTitle();
        }
        ...
        {
            return \Scalar\Scalar::configuration();
        }
...
namespace  {
    ...
    class Scalar extends \Scalar\Facades\Scalar {}
}
